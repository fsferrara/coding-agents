...
- Spec folder (e.g., `specs/user-auth-flow/`): read `spec.md` to understand the scope and purpose. These are markdown specs generated by the `spec-new` skill, living under `specs/<slug>/` with `spec.md`, `design.md`, and `tasks.md`.
